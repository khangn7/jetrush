...
export class Ship_coords {
    ...
    constructor (_points) {
        ...
        this.surfaces = [
            ...
            new Surface(_points[6], _points[22], _points[19]),  // GWT
            new Surface(_points[22], _points[20], _points[19]), // WUT
            // right bottom
            ...
            new Surface(_points[22], _points[6], _points[21]),  // WGV
            new Surface(_points[20], _points[22], _points[21]), // UWV
