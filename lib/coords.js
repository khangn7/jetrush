...
class Surface {
    ...
    constructor(corner1, corner2, corner3) {
        ...
        this.corner1 = addVectors(center, scaledVector(diff, 1.01));
        diff = subtractVectors(center, corner2);
        this.corner2 = addVectors(center, scaledVector(diff, 1.01));
        diff = subtractVectors(center, corner3);
        this.corner3 = addVectors(center, scaledVector(diff, 1.01));
    }
}
