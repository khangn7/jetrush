...
/**
     ...
     */
export function rotate_vector_around_axis(v, angle, theta, phi) {
    // axis of rotation is k

    // transform v with T(v) such that T(k) lies on z=0 plane
    ...
    // transform v such that k lies on positive y axis
